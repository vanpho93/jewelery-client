...
export class Numbers {
  ...
  private _number_attribute_id: string;
  ...
  get number_attribute_id(): string {
    return this._number_attribute_id;
  }

  set number_attribute_id(value: string) {
    this._number_attribute_id = value;
  }
