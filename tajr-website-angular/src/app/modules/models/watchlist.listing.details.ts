...
import {WatchlistHitsDetails} from "./watchlist.hits.details";

export class WatchlistListingDetails {
  private _total: string;
  private _from: string;
  private _size: string;
  private _listing_ids: Strings[];
  private _watchlist_ids: Strings[];
  private _hits: WatchlistHitsDetails[];
  ...
  get hits(): WatchlistHitsDetails[] {
    return this._hits;
  }

  set hits(value: WatchlistHitsDetails[]) {
    this._hits = value;
  }
}
